...
function CartSM({ toggle }) {
  ...
  const reduxState = useSelector((state) => state.cart.cart);
  ...
  return (
    <>
      <div className="md:hidden flex items-center justify-between">
        ...
        <button onClick={continueToCheckout} className="flex items-cetenr gap-1 bg-zomato-400 px-3 py-1 text-white rounded-lg">
